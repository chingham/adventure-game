...
/// </summary>
sealed class InventoryPanel(UiModule ui, GameFlow flow, Fonts fonts, Icons icons, Inventory inventory, InventoryShowroom showroom) : IUiRecipe {
    // Palette
    ...
    public void Compose(UiComposer ui) {
        ...
        var isOpen = flow.IsOpen(Screens.Inventory);
